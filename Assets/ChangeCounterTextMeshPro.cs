...
namespace PaintIn3D.Examples {
	...
	public class P3dChangeCounterTextMeshPro : MonoBehaviour {
		...
		public int DecimalPlaces { set { decimalPlaces = value; } get { return decimalPlaces; } }
...
namespace PaintIn3D.Examples {
	...
	[CustomEditor(typeof(P3dChangeCounterTextMeshPro))]
	public class P3dChangeCounterTextMeshPro_Editor : P3dEditor<P3dChangeCounterTextMeshPro> {
